...
import com.bolivariano.student.common.StandarizedApiExceptionResponse;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<WrapperResponse<?>> handleTeacherValidationException(StudentAlreadyExistsException ex) {
